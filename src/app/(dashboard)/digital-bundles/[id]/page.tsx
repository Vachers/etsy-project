...
export default function DigitalBundleDetailPage() {
  ...
  if (!product) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <Button onClick={() => router.push("/digital-bundles")} className="mt-4">
          Geri Dön
        </Button>
      </div>
    );
  ...
  return (
    <ProductDetailPage
      ...
      icon={<Boxes className="h-4 w-4 text-primary-600" />}
      categoryLabel="Dijital Paket"
    />
  );
}
