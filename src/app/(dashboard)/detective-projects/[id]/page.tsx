...
export default function DetectiveProjectDetailPage() {
  ...
  if (!product) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <Button onClick={() => router.push("/detective-projects")} className="mt-4">
          Geri Dön
        </Button>
      </div>
    );
  ...
  return (
    <ProductDetailPage
      ...
      icon={<Search className="h-4 w-4 text-primary-600" />}
      categoryLabel="Dedektif Projesi"
    />
  );
}
